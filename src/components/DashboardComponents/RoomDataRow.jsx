...
const RoomDataRow = ({ room, refetch }) => {
  ...
  return (
    <tr>
      ...
      <td className='px-5 py-5 border-b border-gray-200 bg-white text-sm'>
        <button onClick={()=>handleDeleteRoom(room?._id)} className='relative cursor-pointer inline-block px-3 py-1 font-semibold text-green-900 leading-tight'>
          <span
            aria-hidden='true'
      ...
      <td className='px-5 py-5 border-b border-gray-200 bg-white text-sm'>
        <Link to={`updateRoom/${room?._id}`} className='relative cursor-pointer inline-block px-3 py-1 font-semibold text-green-900 leading-tight'>
          <span
            aria-hidden='true'
